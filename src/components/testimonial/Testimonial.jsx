            ...
            <div className="flex flex-wrap -m-4">
                <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                    <div className="h-full text-center">
                        ...
                        <p style={{color: mode === 'dark' ? 'white' : ''}} className="leading-relaxed">Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi eius nam cumque, perspiciatis aliquid nihil corporis obcaecati iusto amet vero praesentium eos quos voluptate facere corrupti dicta dolore maxime consectetur?</p>
                        <span className="inline-block h-1 w-10 rounded bg-pink-500 mt-6 mb-4" />
                        <h2 style={{color: mode === 'dark' ? '#ff4162' : ''}} className="text-gray-900 font-medium title-font tracking-wider text-sm uppercase">UTKU TOYGUN BEKTASOGLU</h2>
                        <p style={{color: mode === 'dark' ? 'white' : ''}} className="text-gray-500">JUNIOR WEB DEVELOPER</p>
                    </div>
                </div>
                <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                    <div className="h-full text-center">
