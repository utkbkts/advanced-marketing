...
const DashboardTab = () => {
  ...
  const { mode, products, edithandle, deleteProduct, order, userdata } =
    context;
  const add = () => {
        ...
        <Tabs defaultIndex={0} className=" ">
          <TabList className="md:flex md:space-x-8 bg-  grid grid-cols-2 text-center gap-4   md:justify-center mb-10 ">
            <Tab>
              <button
                type="button"
                className="font-medium border-b-2 hover:shadow-blue-700 border-blue-400 text-blue-500 rounded-lg text-xl shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]  px-5 py-1.5 text-center bg-[#605d5d12] "
              >
            ...
            <Tab>
              <button
                type="button"
                className="font-medium border-b-2 border-slate-500 bg-[#605d5d12] text-slate-500 rounded-lg text-xl  hover:shadow-slate-700 shadow-[inset_0_0_8px_rgba(0,0,0,0.6)]   px-5 py-1.5 text-center "
              >
                <div className="flex gap-2 items-center">
                  <FaUser /> Users
                </div>
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td
                        ...
                        style={{ color: mode === "dark" ? "white" : "" }}
                      >
                        <img className="w-32 h-32" src={item.photoURL} alt="" />
                      </td>
                      <td
                        className="px-6 py-4 text-black "
                        style={{ color: mode === "dark" ? "white" : "" }}
